...
values."
  (setq-default
   ...
   ;; with a supported t3ype is opened). Possible values are `all', `unused'
...
values."
  ...
  (setq-default
   ...
   ;; Either spacemacs, vim, all-the-icons or custom (needs to be set otherwise one test fails when syncing the configuration)
